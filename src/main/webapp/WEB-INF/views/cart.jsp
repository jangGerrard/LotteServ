                        ...
                        <div class="col-md-12 col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body card-padding">
                                    <form action="${ctx }/cart/dosome.lotte" id ="cart_form"
												method="post">
												...
												<button class="btn btn-primary pull-right" type="button" onclick="onBill();"
													><span class="zmdi zmdi-card zmdi-hc-fw"></span> ToBill</button>
												<input type="hidden" name ="whichBtn" id = "whichBtn" value = 1/>
												<button class="btn btn-primary pull-right" type="button" onClick = "onDelete();" 
