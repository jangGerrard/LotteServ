		...
		success:function(response){
			...
			for(var i = 0 ; i < jsonArr.length; i++){
				...
				var el = '<div class="row">';
	                el += '<div class="col-md-5 col-sm-6">';
	                el += '    <div class="card">';
	                ...
	                el += '             <img src="${ctx}/product/download.lotte?no='+jsonArr[i].id+' " alt="">';
	                el += '             <h2>'+jsonArr[i].price+'</h2>';
	                el += '            <p>'+jsonArr[i].content+'</p>';
	                el += '<button class="btn btn-primary pull-right" type="button" value="'+jsonArr[i].id+'" onClick = "addCart(this);"';
					el += '><span class="zmdi zmdi-shopping-cart-plus zmdi-hc-fw"></span> AddCart</button>';
	                el += '         </div>';
	                el += '     </div>';
	                el += ' </div>';
	                el += ' </div>';
...
function addCart( btn){
	//alert(btn.value);
	var _user_name = document.getElementById('loginEmail').value;
	var usr_ =   + '';
	 $.ajax({
		type: 'GET' ,
		url: '${ctx}/android/addcart.lotte' ,
		contentType: 'application/json',
		data : {user_name : _user_name , prod_id : btn.value },
		success:function(response){
			alert(success);
		}
	});
...
<body>
		<input type ="hidden" id="loginEmail" value ="${loginEmail}" />
        <header id="header">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="card">
                                ...
                                <div class="card-body card-padding">
                                    <img src="${ctx}/product/download.lotte?no=1" alt="">
                                    <h2>KRW10000</h2>
                                    <p>content</p>
                                </div>
                            </div>
